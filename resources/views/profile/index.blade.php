...
@section('content')
    <div class="ui container">
        {{--<div class="ui aligned center aligned">--}}
            <h2 class="ui teal header center aligned">個人資料</h2>
            <div class="ui header center aligned">
                {{-- Gravatar大頭貼 --}}
                <a href="https://zh-tw.gravatar.com/" target="_blank" title="透過Gravatar更換照片" class="ui medium circular image">
            ...
            <div style="text-align: center">
                <a href="{{ route('profile.edit') }}" class="ui icon red basic button"><i class="icon edit"></i> 編輯資料</a>
                <a href="{{ route('profile.change-password') }}" class="ui icon brown basic button"><i class="icon lock"></i> 修改密碼</a>
            </div>
        {{--</div>--}}
    </div>
@endsection
